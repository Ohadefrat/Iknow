...
export class Level3Component implements OnInit {
  ...
  ngOnInit(): void {
    ...
    firstcard4.backgroundImage ="~/app/assets/zebra.jpg";
    ...
    if(screen.mainScreen.widthDIPs > 360){
      ...
      foulbl.backgroundPosition = "0% 145%";
      foulbl.backgroundSize = "800px 900px"
      console.log("true");
    ...
    if(screen.mainScreen.widthDIPs <= 360){
      ...
      foulbl.backgroundPosition = "125% -45%";
      console.log("true");
        ...
        case 1:
          if (this.imagesArray[index - 1].image.translateX >= -55 && this.imagesArray[index - 1].image.translateX >= -45 && this.imagesArray[index - 1].image.translateY == -400) {
            ...
            if (this.firstlblEnable == true) {
              ...
              cardImgfirstlbl.backgroundImage ="~/app/assets/zebra.jpg";
        ...
        case 2:
          if ((this.imagesArray[index - 1].image.translateX >= -55 && this.imagesArray[index - 1].image.translateX <= -45) && (this.imagesArray[index - 1].image.translateY >= -200 && this.imagesArray[index - 1].image.translateY <= -190)) {
            ...
            if (this.seclblEnable == true) {
              var cardImgseclbl= <Label>this.page.getViewById("foulbl");

              cardImgseclbl.backgroundImage ="~/app/assets/zebra.jpg";
              ...
              cardfirstcard1.backgroundImage ="~/app/assets/zebra.jpg";
              if(screen.mainScreen.widthDIPs > 360){
                var firstlbl
                firstlbl = <AbsoluteLayout>this.page.getViewById("firstcard1");
                
                firstlbl.backgroungRepeat = 'no-repeat';
                firstlbl.backgroundPosition = "0% 0%";
                firstlbl.backgroundSize = "800px 900px";
        ...
        case 3:
          if (this.imagesArray[index - 1].image.translateX <= 95 && this.imagesArray[index - 1].image.translateX >= 85 && this.imagesArray[index - 1].image.translateY >= -200 && this.imagesArray[index - 1].image.translateY <= -190) {
            ...
            if (this.trlblEnable == true) {
              ...
              cardImgtrlbl.backgroundImage ="~/app/assets/zebra.jpg";
              ...
              cardfirstcard2.backgroundImage ="~/app/assets/zebra.jpg";
              if(screen.mainScreen.widthDIPs > 360){
                var seclbl
                seclbl = <AbsoluteLayout>this.page.getViewById("firstcard2");
                
                seclbl.backgroungRepeat = 'no-repeat';
                seclbl.backgroundPosition = "100% 0%";
                seclbl.backgroundSize = "800px 900px";
              ...
              if(screen.mainScreen.widthDIPs <= 360){
                ...
                seclbl = <AbsoluteLayout>this.page.getViewById("firstcard2");
                seclbl.backgroungRepeat = 'no-repeat';
                seclbl.backgroundPosition = "-25% 220%";
        ...
        case 4:
          if ((this.imagesArray[index - 1].image.translateX <= 105 && this.imagesArray[index - 1].image.translateX >= 85) && (this.imagesArray[index - 1].image.translateY >= -415 &&this.imagesArray[index - 1].image.translateY <= -385)) {
            ...
            if (this.foulblEnable == true) {
              var cardImgfoulbl= <Label>this.page.getViewById("seclbl");
              cardImgfoulbl.backgroundImage ="~/app/assets/zebra.jpg";
              ...
              cardfirstcard3.backgroundImage ="~/app/assets/zebra.jpg";
              if(screen.mainScreen.widthDIPs > 360){
                var trlbl
                trlbl = <AbsoluteLayout>this.page.getViewById("firstcard3");
                
                trlbl.backgroungRepeat = 'no-repeat';
                trlbl.backgroundPosition = "100% 145%";
                trlbl.backgroundSize = "800px 900px";
              ...
              if(screen.mainScreen.widthDIPs <= 360){
                ...
                trlbl = <AbsoluteLayout>this.page.getViewById("firstcard3");
                trlbl.backgroungRepeat = 'no-repeat';
                trlbl.backgroundPosition = "125% 220%";
    ...
    } else if (args.state === 2) // panning
    {
      ...
      switch (index) {
        case 1:
          ...
          if (this.wordArray[index - 1].lbl.translateX >= 10 && this.wordArray[index - 1].lbl.translateX <= 20 &&  this.wordArray[index - 1].lbl.translateY >= -150&&  this.wordArray[index - 1].lbl.translateY <= -140) {
  ...
  navigatorFunc(){
   ...
   if(this.level_Position.includes("level1_3")){
    ...
    this.level_Position.push("level1_3")
   }
    console.log(this.level_Position.length);
    if ( this.score != 36 ){
      this.score = 36

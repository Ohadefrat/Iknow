...
export class Level2Component implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    firstcard4.backgroundImage ="~/app/assets/giraff.jpg";
    ...
    if(screen.mainScreen.widthDIPs > 360){
      ...
      foulbl.backgroundSize = "1180px 800px";
      foulbl.backgroundPosition = "22.5% 125%";
      console.log("true");
    ...
    if(screen.mainScreen.widthDIPs <= 360){
      var foulbl
      foulbl = <AbsoluteLayout>this.page.getViewById("firstcard4");
      foulbl.backgroundSize = "1400px 1100px";
      foulbl.backgroundPosition = "15% -20%";
      console.log("true");
  ...
  onPan5(index: number, args: PanGestureEventData) {
    ...
    } else if (args.state === 2) // panning
    {
      ...
      if (this.imagesArray[index - 1].image.translateY <= -415) {
        this.imagesArray[index - 1].image.translateY = -415
      }
      ...
      switch (index) {
        case 1:
          if ((this.imagesArray[index - 1].image.translateX >= -55 && this.imagesArray[index - 1].image.translateX <= -45) && (this.imagesArray[index - 1].image.translateY >= -200 && this.imagesArray[index - 1].image.translateY <= -190)) {
            ...
            if (this.firstlblEnable == true) {
              var cardImgfirstlbl= <Label>this.page.getViewById("foulbl");

              cardImgfirstlbl.backgroundImage ="~/app/assets/giraff.jpg";
        ...
        case 2:
          if ((this.imagesArray[index - 1].image.translateX <= 105 && this.imagesArray[index - 1].image.translateX >= 85) && (this.imagesArray[index - 1].image.translateY >= -415 &&this.imagesArray[index - 1].image.translateY <= -385)) {
            ...
            if (this.seclblEnable == true) {
              ...
              cardImgseclbl.backgroundImage ="~/app/assets/giraff.jpg";
              ...
              cardfirstcard1.backgroundImage ="~/app/assets/giraff.jpg";
              if(screen.mainScreen.widthDIPs > 360){
                var firstlbl
                firstlbl = <AbsoluteLayout>this.page.getViewById("firstcard1");
                
                firstlbl.backgroungRepeat = 'no-repeat';
                firstlbl.backgroundPosition = "22.5% -65% ";
                firstlbl.backgroundSize = "1180px 800px";
              ...
              if(screen.mainScreen.widthDIPs <= 360){
                var foulbl
                foulbl = <AbsoluteLayout>this.page.getViewById("firstcard1");
                foulbl.backgroundSize = "1400px 1100px";
                foulbl.backgroundPosition = "15% 250%";
                console.log("true");
        ...
        case 3:
          if (this.imagesArray[index - 1].image.translateX <= 95 && this.imagesArray[index - 1].image.translateX >= 85 && this.imagesArray[index - 1].image.translateY >= -200 && this.imagesArray[index - 1].image.translateY <= -190) {
            ...
            if (this.trlblEnable == true) {
              var cardImgtrlbl= <Label>this.page.getViewById("trlbl");

              cardImgtrlbl.backgroundImage ="~/app/assets/giraff.jpg";
              ...
              cardfirstcard2.backgroundImage ="~/app/assets/giraff.jpg";
              if(screen.mainScreen.widthDIPs > 360){
                var seclbl
                seclbl = <AbsoluteLayout>this.page.getViewById("firstcard2");
                
                seclbl.backgroungRepeat = 'no-repeat';
                seclbl.backgroundPosition = "72.5% -65% ";
                seclbl.backgroundSize = "1180px 800px";
              ...
              if(screen.mainScreen.widthDIPs <= 360){
                var foulbl
                foulbl = <AbsoluteLayout>this.page.getViewById("firstcard2");
                foulbl.backgroundSize = "1400px 1100px";
                foulbl.backgroundPosition = "90% -20%";
                console.log("true");
        ...
        case 4:
            if (this.imagesArray[index - 1].image.translateX >= -55 && this.imagesArray[index - 1].image.translateX >= -45 && this.imagesArray[index - 1].image.translateY >= -415&&this.imagesArray[index - 1].image.translateY <= -390) {
              this.imagesArray[index - 1].image.translateX = -55
              this.imagesArray[index - 1].image.translateY = -400
            args.state = 3
            if (this.foulblEnable == true) {
              this.foulblEnable = false
              var cardImgfoulbl= <Label>this.page.getViewById("firstlbl");
              cardImgfoulbl.borderColor="#65e000";
              cardImgfoulbl.backgroundImage ="~/app/assets/giraff.jpg";
              ...
              cardfirstcard3.backgroundImage ="~/app/assets/giraff.jpg";
              if(screen.mainScreen.widthDIPs > 360){
                var trlbl
                trlbl = <AbsoluteLayout>this.page.getViewById("firstcard3");
                
                //trlbl.backgroungRepeat = 'no-repeat';
                trlbl.backgroundPosition = "72.5% 125%";
                trlbl.backgroundSize = "1180px 800px";
              ...
              if(screen.mainScreen.widthDIPs <= 360){
                var foulbl
                foulbl = <AbsoluteLayout>this.page.getViewById("firstcard3");
                foulbl.backgroundSize = "1400px 1100px";
                foulbl.backgroundPosition = "90% 250%";
                console.log("true");
    ...
    } else if (args.state === 2) // panning
    {
      ...
      if(index ==1 ){
        ...
        if(index == 2 ){
          ...
          if (this.wordArray[index - 1].lbl.translateX >= 151) {
            this.wordArray[index - 1].lbl.translateX = 151
          }
      ...
      switch (index) {
        case 1:
          if(screen.mainScreen.widthDIPs <= 360){
            if (this.wordArray[index - 1].lbl.translateX >= 15 && this.wordArray[index - 1].lbl.translateX <= 35 &&  this.wordArray[index - 1].lbl.translateY >= -150&&  this.wordArray[index - 1].lbl.translateY <= -140) {
              this.wordArray[index - 1].lbl.translateX = 28
  ...
  navigatorFunc(){
   ...
   if(this.level_Position.includes("level1_2")){
    
   }
   else{
    this.level_Position.push("level1_2")
   }
    firebase.getCurrentUser()
      .then(user => {
        const usersCollection = firebaseAPI.firestore().collection("Users");

...
@Component({
  selector: 'ns-level2two',
  templateUrl: './level2two.component.html',
  styleUrls: ['./level2two.component.css']
})
export class Level2twoComponent implements OnInit {
  public imagesArray;
  public wordArray;
  ...
  ngOnInit(): void {
    ...
    firstcard9.backgroundImage ="~/app/assets/snake.jpg";
    ...
    if(screen.mainScreen.widthDIPs <= 360){
      ...
      ninelbl.backgroundPosition = "45% 50%";
      console.log("true");
    ...
    } else if (args.state === 2) // panning
    {
      ...
      switch (index) {
        case 1:
          ...
          if (this.imagesArray[index - 1].image.translateX <= 10 && this.imagesArray[index - 1].image.translateX >= -10 && this.imagesArray[index - 1].image.translateY >= -410&& this.imagesArray[index - 1].image.translateY <= -390) {
            this.imagesArray[index - 1].image.translateX = -5
            this.imagesArray[index - 1].image.translateY = -400
            args.state = 3
            if (this.firstlblEnable == true) {
              var cardImgfirstlbl= <AbsoluteLayout>this.page.getViewById("seclbl");

              cardImgfirstlbl.backgroundImage ="~/app/assets/snake.jpg";
        ...
        case 2:
          /*if (this.imagesArray[index - 1].image.translateX <= 100 && this.imagesArray[index - 1].image.translateX >= 95  && this.imagesArray[index - 1].image.translateY >= -400 && this.imagesArray[index - 1].image.translateY <= -390) {
            ...
            this.imagesArray[index - 1].image.translateY = -400*/
          if ((this.imagesArray[index - 1].image.translateX >= -110 && this.imagesArray[index - 1].image.translateX <= -100) && (this.imagesArray[index - 1].image.translateY >= -310 && this.imagesArray[index - 1].image.translateY <= -290)) {
              this.imagesArray[index - 1].image.translateX = -105
              this.imagesArray[index - 1].image.translateY = -300
            args.state = 3
            if (this.seclblEnable == true) {
              this.seclblEnable = false
              var cardImgtrlbl= <AbsoluteLayout>this.page.getViewById("foulbl");
              cardImgtrlbl.backgroundImage ="~/app/assets/snake.jpg";
              ...
              cardfirstcard1.backgroundImage ="~/app/assets/snake.jpg";
              if(screen.mainScreen.widthDIPs > 360){
                var firstlbl
              ...
              if(screen.mainScreen.widthDIPs <= 360){
                ...
                firstlbl.backgroungRepeat = 'no-repeat';
                firstlbl.backgroundPosition =  "45% -15%";
        ...
        case 3:
          ...
          if (this.imagesArray[index - 1].image.translateX >= -110 && this.imagesArray[index - 1].image.translateX <= -100 && this.imagesArray[index - 1].image.translateY == -400) {
            ...
            if (this.trlblEnable == true) {
              ...
              var cardImgninelbl= <AbsoluteLayout>this.page.getViewById("firstlbl");
              cardImgninelbl.backgroundImage ="~/app/assets/snake.jpg";
              ...
              cardfirstcard2.backgroundImage ="~/app/assets/snake.jpg";
              if(screen.mainScreen.widthDIPs > 360){
                var seclbl
              ...
              if(screen.mainScreen.widthDIPs <= 360){
                ...
                seclbl.backgroungRepeat = 'no-repeat';
                seclbl.backgroundPosition =  "-30% 50%";
        ...
        case 4:
          ...
          if (this.imagesArray[index - 1].image.translateX <= 100 && this.imagesArray[index - 1].image.translateX >= 95 && this.imagesArray[index - 1].image.translateY >= -200 && this.imagesArray[index - 1].image.translateY <= -190) {
            ...
            if (this.foulblEnable == true) {
              ...
              cardImgsevenlbl.backgroundImage ="~/app/assets/snake.jpg";
              ...
              if(screen.mainScreen.widthDIPs <= 360){
                ...
                trdlvl.backgroungRepeat = 'no-repeat';
                trdlvl.backgroundPosition =  "-30% -15%";
        ...
        case 5:
          ...
          if (this.imagesArray[index - 1].image.translateX <= 100 && this.imagesArray[index - 1].image.translateX >= 95  && this.imagesArray[index - 1].image.translateY >= -400 && this.imagesArray[index - 1].image.translateY <= -390) {
            ...
            if (this.fivelblEnable == true) {
              ...
              var cardImgseclbl= <AbsoluteLayout>this.page.getViewById("trlbl");
              cardImgseclbl.backgroundImage ="~/app/assets/snake.jpg";
              ...
              if(screen.mainScreen.widthDIPs <= 360){
                ...
                foulvl.backgroungRepeat = 'no-repeat';
                foulvl.backgroundPosition =  "120% 113%";
        ...
        case 6:
          ...
          if ((this.imagesArray[index - 1].image.translateX >= -110 && this.imagesArray[index - 1].image.translateX <= -100) && (this.imagesArray[index - 1].image.translateY >= -200 && this.imagesArray[index - 1].image.translateY <= -190)) {
            ...
            if (this.sixlblEnable == true) {
              ...
              var cardImgfoulbl= <AbsoluteLayout>this.page.getViewById("sevenlbl");
              cardImgfoulbl.backgroundImage ="~/app/assets/snake.jpg";
              ...
              cardfirstcard5.backgroundImage ="~/app/assets/snake.jpg";
              if(screen.mainScreen.widthDIPs > 360){
                var fivelbl
              ...
              if(screen.mainScreen.widthDIPs <= 360){
                ...
                fivelbl.backgroungRepeat = 'no-repeat';
                fivelbl.backgroundPosition =  "120% -15%";
        ...
        case 7:
          if ((this.imagesArray[index - 1].image.translateX >= -10 && this.imagesArray[index - 1].image.translateX <= 0) && (this.imagesArray[index - 1].image.translateY >= -200 && this.imagesArray[index - 1].image.translateY <= -190)) {
            ...
            if (this.sevenlblEnable == true) {
              ...
              var cardImgeightlbl= <AbsoluteLayout>this.page.getViewById("eightlbl");
              cardImgeightlbl.backgroundImage ="~/app/assets/snake.jpg";
              ...
              cardfirstcard6.backgroundImage ="~/app/assets/snake.jpg";
              if(screen.mainScreen.widthDIPs > 360){
                var sixlbl
              ...
              if(screen.mainScreen.widthDIPs <= 360){
                ...
                sixlbl.backgroungRepeat = 'no-repeat';
                sixlbl.backgroundPosition =  "-30% 113%";
        ...
        case 8:
          if ((this.imagesArray[index - 1].image.translateX <= 100 && this.imagesArray[index - 1].image.translateX >= 95) && (this.imagesArray[index - 1].image.translateY >= -300 && this.imagesArray[index - 1].image.translateY <= -290)) {
            ...
            if (this.eightlblEnable == true) {
              ...
              var cardImgfivelbl= <AbsoluteLayout>this.page.getViewById("sixlbl");
              cardImgfivelbl.backgroundImage ="~/app/assets/snake.jpg";
        ...
        case 9:
          ...
          if ((this.imagesArray[index - 1].image.translateX >=-10 && this.imagesArray[index - 1].image.translateX <= 0) && (this.imagesArray[index - 1].image.translateY >= -300 && this.imagesArray[index - 1].image.translateY <= -290)) {
            ...
            if (this.ninelblEnable == true) {
              ...
              var cardImgsixlbl= <AbsoluteLayout>this.page.getViewById("fivelbl");
              cardImgsixlbl.backgroundImage ="~/app/assets/snake.jpg";
              ...
              cardfirstcard8.backgroundImage ="~/app/assets/snake.jpg";
              if(screen.mainScreen.widthDIPs > 360){
                var eightlbl
              ...
              if(screen.mainScreen.widthDIPs <= 360){
                ...
                eightlbl.backgroungRepeat = 'no-repeat';
                eightlbl.backgroundPosition = "120% 50%";
    ...
    } else if (args.state === 2) // panning
    {
      ...
      switch (index) {
        case 2:
          ...
          if (this.wordArray[index - 1].lbl.translateX >= -65 && this.wordArray[index - 1].lbl.translateX <= -45 &&  this.wordArray[index - 1].lbl.translateY >= -210&&  this.wordArray[index - 1].lbl.translateY <= -190) {
            this.wordArray[index - 1].lbl.translateX = -50
            this.wordArray[index - 1].lbl.translateY = -200
            args.state = 3
  ...
  navigatorFunc(){
   ...
   if(this.level_Position.includes("level2_2")){
    
   }
   else{
    this.level_Position.push("level2_2")
   }
    firebase.getCurrentUser()
      .then(user => {
        const usersCollection = firebaseAPI.firestore().collection("Users");
